...
const CartScreen = () => {
  ...
  const shippingFee = getShippingFee(''); // default preview ₱200
      ...
      {cartItems.length === 0 ? (
        <div style={{
          ...
          <button
            ...
            style={{
              backgroundColor: 'var(--accent)', color: 'var(--btn-text)',
              padding: '12px 32px', borderRadius: '10px', fontWeight: '800',
        ...
        <div style={{ display: 'flex', gap: '24px', flexWrap: 'wrap' }}>
          ...
          <div style={{ flex: '1 1 600px' }}>
            <div style={{
              ...
              <div style={{
                ...
                padding: '14px 20px', backgroundColor: 'var(--bg-soft)',
                borderBottom: '2px solid var(--accent)', fontSize: '12px', fontWeight: '700',
              ...
              {cartItems.map((item, index) => (
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
                    <div style={{
                      width: '64px', height: '64px', backgroundColor: 'var(--bg-soft)',
                    ...
                    <div>
                      <Link to={`/product/${item._id}`} style={{
                        ...
                        textDecoration: 'none', display: '-webkit-box',
                  ...
                  <div style={{ textAlign: 'center' }}>
                    <select
                      ...
                      style={{
                        backgroundColor: 'var(--bg-soft)', border: '1px solid var(--accent-dark)',
                        color: 'var(--text-main)', borderRadius: '6px',
                        padding: '4px 8px', fontSize: '13px', cursor: 'pointer', width: '60px',
                      }}
                    >
          ...
          <div style={{ flex: '0 0 300px' }}>
            <div style={{
              ...
              <div style={{
                padding: '16px 20px', backgroundColor: 'var(--bg-soft)',
              ...
              <div style={{ padding: '20px' }}>
                {[
                  { label: `Item Cost (${totalQty} pcs)`, value: formatPeso(subtotal) },
                  {
                    label: 'Shipping Fee 🚚',
                    sublabel: 'Exact fee based on your address at checkout',
                    value: formatPeso(shippingFee),
                    accent: true,
                  },
                ].map((row, i) => (
                  <div key={i} style={{
                ...
                <div style={{
                  ...
                  <span style={{ color: 'var(--text-main)', fontWeight: '700', fontSize: '15px' }}>Total Amount</span>
                ...
                <button
                  ...
                  style={{
                    width: '100%', backgroundColor: 'var(--accent)', color: 'var(--btn-text)',
                ...
                <p style={{ fontSize: '11px', color: 'var(--text-muted)', textAlign: 'center', marginTop: '10px' }}>
                  🔒 Shipping fee confirmed at checkout based on your location
                </p>
              </div>
            </div>
          </div>
